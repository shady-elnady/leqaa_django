...
(gj.widget = function () {
        ...
        if (/^\d+$/.test(a)) g = new Date(a);
          ...
          for (
            ...
            ["d", "dd"].indexOf(f[d]) > -1
              ...
              ? (i = parseInt(e[d], 10) - 1)
              : "mmm" === f[d]
              ? (i = gj.core.messages[c || "en_US"].monthShortNames.indexOf(
                  e[d]
                ))
              : "mmmm" === f[d]
              ? (i = gj.core.messages[c || "en_US"].monthNames.indexOf(e[d]))
      ...
      for (h = h.splice(1, h.length - 2), i = 0; i < g.length; i++)
        switch (((d = h[i] || ""), g[i])) {
          ...
          case "dd":
            ...
            break;
          case "ddd":
            f += gj.core.messages[c || "en_US"].weekDaysShort[a.getDay()] + d;
            break;
          case "dddd":
            f += gj.core.messages[c || "en_US"].weekDays[a.getDay()] + d;
            break;
          case "m":
            f += a.getMonth() + 1 + d;
            break;
          ...
          case "mmm":
            f +=
              gj.core.messages[c || "en_US"].monthShortNames[a.getMonth()] + d;
            break;
          case "mmmm":
            f += gj.core.messages[c || "en_US"].monthNames[a.getMonth()] + d;
            break;
          case "yy":
  ...
  (gj.dialog.messages["en_US"] = { Close: "Close", DefaultTitle: "Dialog" }),
  ...
  (gj.datetimepicker = { plugins: {}, messages: { en_US: {} } }),
  ...
  (gj.slider = { plugins: {}, messages: { en_US: {} } }),
  (gj.slider.config = {
    base: {
      min: 0,
      max: 100,
  ...
  (gj.colorpicker = { plugins: {}, messages: { en_US: {} } }),
